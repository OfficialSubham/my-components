                ...
                <div className="flex-1 rounded-b-2xl border border-neutral-300 text-black">
                    <div className="p-4">
                        ...
                        <p className="text-neutral-400 text-sm leading-tight">
                            Monitor your shipment status in real-time. Stay informed about
                            yur delivery&apos;s progress every step of the way
                        </p>
                    </div>
                    <div className="border-t justify-between items-center border-t-neutral-300 flex gap-4 p-4">
                        <button className="border border-neutral-300 rounded-2xl px-3 py-2 cursor-pointer">
                            View Status
                        </button>
